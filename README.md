...
🚀 Overview
This is a full-stack Airbnb clone built using the MERN stack (MongoDB, Express.js, Node.js,React.js). It allows users to list, browse, and book properties with secure authentication using passport-local mongoose.
